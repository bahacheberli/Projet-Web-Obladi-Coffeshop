  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
           ...
           <!-- AFFICHAGE DE La moyennes des ages des clients :) -->
      ...
      <div id="afficher" >
         ...
         <h1 style="margin-top: 50px ;margin-left: 000px ;text-align: center;color: #2c3e50">La Moyenne Des Ages des Clients :</h1>
          <h1 style="margin-left: 000px ;text-align: center;color: #c0392b ;font-size: 100px"><?php echo $moyenneAge/$nbclients;?> ans</h1>
