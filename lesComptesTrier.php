  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">les Comptes Triées</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">les Comptes Triées</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div id="afficher" class="card-body" >
        ...
        <table class="table table-bordered table-striped" style="margin-right: 000px ;margin-left: 00px ;margin-top: 35px; background-color: #dfe6e9">
    <thead>
    <tr>
        <th>Identifient</th>
        <th>Nom</th>
        ...
        <tr>
            ...
            <td>
                <form action="modifierClient.php" method="get">
                    ...
                    <input type="submit" name="modifier" value="modifier" class="btn bg-info style="background-color: #5F9EA0;">
                </form>
            ...
            <input type="hidden" id="id" name="id" value="'.$row["idclient"].'">
    <input type="submit" name="supprimer" value="supprimer" class="btn bg-danger style="background-color: #DEB887">
