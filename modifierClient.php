...
<head>
  ...
  <title>Modifier les Comptes Client</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Modifier les Comptes</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Modifier les Comptes</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<form  method="post" action="modClient.php"  onsubmit="return verif()" style="background-color: #b2bec3">
    ...
    <table class="table table-bordered table-striped" >
        ...
        <th>
            <td><input type="submit" value="Modifier" class="btn bg-info" ></td>
        </th>
    </table>
</div>
</form>
