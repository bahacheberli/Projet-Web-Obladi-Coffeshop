  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div id="afficher" >
           ...
           <h1 style="margin-top: 50px ;margin-left: 000px ;text-align: center;color: #2c3e50">Le Nombre Totales Des Clients est :</h1>
          <h1 style="margin-left: 000px ;text-align: center;color: #c0392b ;font-size: 100px"><?php echo $nbclients ;?></h1>
         </div>
