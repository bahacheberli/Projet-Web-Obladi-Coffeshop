...
if(isset($_POST['search']))
{
    $search=$_POST['search'];
    $cli = new clientC();
$listcli = $cli->afficherClient2($search);
}
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">les Comptes recherchées</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">les Comptes recherchées</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div id="afficher"  class="card-body">
        ...
        <table class="table table-bordered table-striped" style="margin-right: 00px ;margin-left: 00px ;margin-top: 35px; background-color: #dfe6e9">
    <thead>
    <tr>
        <th>Identifient</th>
        <th>Nom</th>
